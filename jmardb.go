...
func (c *client) Search(status string, infotype string, title string, headtitle string, eventid string, areaname string, areacode string, datetime string, reportdatetime string, targetdatetime string, validdatetime string, limit int, offset int, order string) ([]Search, error) {
	param := url.Values{}
...
func (c *client) Area(latitude, longitude float64, limit int) ([]Area, error) {
	param := url.Values{}
